  ...
  <v-container fluid fill-height>
    <v-layout align-center justify-center>
      <v-card class="elevation-12" width="45em">
        <v-toolbar>
          <v-toolbar-title class="display-1 grabient"><span class="font-sedan">Deck News</span></v-toolbar-title>
        </v-toolbar>
        <v-card-text class="pb-0">
          <v-form>
            ...
            <p class="text-xs-center mt-1"> You don't have an account? You can create one
              <a @click="goSignup"> <span class="subheading grabient">here</span></a>
            </p>
          </v-form>
          <v-divider class="mx-5"></v-divider>
          <p class="mt-3 text-xs-center"> or </p>
        </v-card-text>
    ...
    <svg viewBox="0 0 366 372" xmlns="http://www.w3.org/2000/svg"><path
      ...
      fill="#34A853"/></svg>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn @click="login"><span class="grabient">Login</span></v-btn>
        </v-card-actions>
      </v-card>
    </v-layout>
